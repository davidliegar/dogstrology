 ...
 * puede comprobar: hay una sola llamada de red en toda la app
 * (`CdnDailyRepository`), no hay Sentry ni analítica instalados, los avisos son
 * locales y la foto se copia al almacenamiento privado. Si alguna de esas cosas
 * cambia, esta página miente — y es de las que no puede.
 */
...
const VERSION = 'Versión de 1 de septiembre de 2026';
...
const SECTIONS = [
  ...
  },
  {
    ...
    body: [
      'Son dos cosas, y ninguna lleva información sobre ti ni sobre tu mascota.',
  ...
  {
    title: 'Sin publicidad y sin analítica',
    body: [
      'La app no muestra anuncios de ningún tipo y no lleva ninguna herramienta de analítica ni de seguimiento instalada.',
      'Si en el futuro se añade analítica, será agregada y sin identificadores de dispositivo, y esta página se actualizará antes de que ocurra.',
    ],
  },
  {
    title: 'Quién más interviene',
    body: [
      'Cloudflare aloja y sirve el contenido diario. RevenueCat gestiona el estado de las suscripciones, y sus servidores están en Estados Unidos. Google Play cobra las compras y gestiona las devoluciones, con sus propias condiciones y su propia política de privacidad.',
  ...
  },
  {
    ...
    body: [
      ...
      'En la práctica, la mayoría se ejercen sin pedir permiso a nadie: los datos están en tu móvil, se editan desde la propia app y desinstalarla los borra todos.',
